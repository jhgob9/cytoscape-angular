...
@Component({
  selector: 'app-cola-layout',
  templateUrl: './cola-layout.component.html',
  styleUrls: ['./cola-layout.component.css']
})
export class ColaLayoutComponent implements OnInit {
  public cy: any;
  ...
  ngOnInit() {
    this.SubTitle.subtitle = 'Cola layout';
    removePopper();
    let cy = this.cy;
    cy = cytoscape({
      container: document.getElementById('cyColaLayout'),
