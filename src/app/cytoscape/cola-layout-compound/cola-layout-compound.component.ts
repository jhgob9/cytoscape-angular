...
@Component({
  selector: 'app-cola-layout-compound',
  templateUrl: './cola-layout-compound.component.html',
  styleUrls: ['./cola-layout-compound.component.css']
})
export class ColaLayoutCompoundComponent implements OnInit {
  public cy: any;
  ...
  ngOnInit() {
    this.SubTitle.subtitle = 'Cola layout(compound)';
    removePopper();
    let cy = this.cy;
    cy = cytoscape({
      container: document.getElementById('cyColaLayoutCompound'),
