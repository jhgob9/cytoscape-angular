...
@Component({
  selector: 'app-pie-style',
  templateUrl: './pie-style.component.html',
  styleUrls: ['./pie-style.component.css']
})
export class PieStyleComponent implements OnInit {
  public cy: any;
  ...
  ngOnInit() {
    this.SubTitle.subtitle = 'Pie style';
    removePopper();
    let cy = this.cy;
    cy = cytoscape({
      container: document.getElementById('cyPieStyle'),
